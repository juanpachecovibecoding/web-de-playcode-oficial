    ...
    <section id="nosotros" className="py-24 bg-white relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            <div className="inline-block px-3 py-1 bg-[#d6e4f0] border-2 border-slate-900 shadow-[2px_2px_0_0_#0f172a] text-[#152945] text-sm font-pixel tracking-wide mb-6">
              SOBRE NOSOTROS
            </div>
          ...
          <div>
            <div className="bg-slate-900 p-8 text-white border-4 border-[#152945] shadow-[8px_8px_0_0_#152945] relative overflow-hidden mt-0 lg:mt-24">
        ...
        <div className="bg-slate-50 p-6 md:p-10 border-4 border-slate-900 shadow-[8px_8px_0_0_#0f172a]">
          <h3 className="font-pixel text-2xl text-slate-900 mb-10 flex items-center gap-3">
            <Users className="text-[#152945] w-8 h-8" /> EL EQUIPO DIRECTIVO
          </h3>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-[#1e3a5f] mb-3">Co-fundadora · Tecnología Educativa & Diseño de Experiencias</p>
                <div className="text-sm text-slate-700 space-y-3 leading-relaxed">
                  ...
                  <p>En <a href="https://www.linkedin.com/company/devtechar/" target="_blank" rel="noopener noreferrer" className="text-[#152945] hover:underline font-semibold">DevTech</a> lidera el diseño de las experiencias de capacitación: cómo se enseña la tecnología importa tanto como la tecnología misma.</p>
                  <p className="italic font-medium text-slate-900 border-l-4 border-[#2a5280] pl-4 mt-4 py-1">"No basta con implementar una herramienta. Hay que diseñar la experiencia para que las personas quieran y puedan usarla."</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-[#152945] mb-3">Co-fundador · Gestión Educativa & Estrategia en IA</p>
                <div className="text-sm text-slate-700 space-y-3 leading-relaxed">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-center gap-4 bg-white p-4 border-2 border-slate-900 shadow-[4px_4px_0_0_#0f172a] hover:-translate-y-1 hover:shadow-[6px_6px_0_0_#0f172a] transition-all">
              <div className="bg-indigo-100 p-3 border-2 border-slate-900 text-[#152945]">
            ...
            <div className="flex items-start sm:items-center gap-4 bg-white p-4 border-2 border-slate-900 shadow-[4px_4px_0_0_#0f172a] hover:-translate-y-1 hover:shadow-[6px_6px_0_0_#0f172a] transition-all md:col-span-2 w-full max-w-2xl mx-auto">
              <div className="bg-[#152945] p-3 border-2 border-slate-900 text-white shrink-0 mt-1 sm:mt-0">
