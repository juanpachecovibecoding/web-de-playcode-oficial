...
export const COLOR_PALETTES: Record<string, { name: string; top: string; left: string; right: string; styles: ThemeStyles }> = {
  'blue-soft': {
    name: 'Azul Suave',
    top: '#dbeafe',
    left: '#2563eb',
    ...
    styles: {
      bg: 'bg-[#f0f6ff]',
      sidebarBg: 'bg-[#1e40af]',
      sidebarBorder: 'border-[#3b82f6]',
      activeTabBg: 'bg-[#bfdbfe]',
      activeTabText: 'text-[#1e385c] border-[#1e385c] shadow-[2px_2px_0_0_#ffffff]',
      headerBorder: 'border-[#60a5fa]',
      cardBg: 'bg-white',
      cardBorder: 'border-2 border-[#1e40af]',
      cardShadow: 'shadow-[4px_4px_0_0_#1e40af]',
      textColor: 'text-[#0f172a]',
      subtextColor: 'text-[#3b82f6]',
      primaryBtnBg: 'bg-[#2563eb]',
      primaryBtnHover: 'hover:bg-[#1d4ed8]',
      primaryBtnText: 'text-white border-2 border-[#1e40af] shadow-[2px_2px_0_0_#000000]',
      badgeBg: 'bg-[#dbeafe] text-[#1e40af] border border-[#93c5fd]',
      badgeText: 'text-[#1e40af]',
      tabBarBg: 'bg-[#1e40af]',
      tabBarBorder: 'border-[#1e3a5f]',
      tabActiveBg: 'bg-white',
      tabActiveText: 'text-[#1e40af] font-extrabold border-b-4 border-[#2563eb]',
      tabInactiveText: 'text-white',
      tabInactiveHover: 'hover:bg-[#1d4ed8]',
      tabShadow: 'shadow-[4px_4px_0_0_#1e40af]'
    }
  },
  'gray-blue': {
    name: 'Gris Azul',
    ...
    styles: {
      bg: 'bg-[#f8fafc]',
      sidebarBg: 'bg-[#334155]',
      sidebarBorder: 'border-[#2563eb]',
      activeTabBg: 'bg-[#cbd5e1]',
      activeTabText: 'text-[#0f172a] border-[#0f172a] shadow-[2px_2px_0_0_#ffffff]',
      headerBorder: 'border-[#94a3b8]',
      cardBg: 'bg-white',
      cardBorder: 'border-2 border-[#334155]',
      cardShadow: 'shadow-[4px_4px_0_0_#2563eb]',
      textColor: 'text-[#0f172a]',
      subtextColor: 'text-[#475569]',
      primaryBtnBg: 'bg-[#2563eb]',
      primaryBtnHover: 'hover:bg-[#1d4ed8]',
      primaryBtnText: 'text-white border-2 border-[#0f172a] shadow-[2px_2px_0_0_#000000]',
      badgeBg: 'bg-[#e2e8f0] text-[#1e293b] border border-[#cbd5e1]',
      badgeText: 'text-[#1e293b]',
      tabBarBg: 'bg-[#334155]',
      tabBarBorder: 'border-[#1e293b]',
      tabActiveBg: 'bg-white',
      tabActiveText: 'text-[#2563eb] font-extrabold border-b-4 border-[#2563eb]',
      tabInactiveText: 'text-white',
      tabInactiveHover: 'hover:bg-[#475569]',
      tabShadow: 'shadow-[4px_4px_0_0_#334155]'
    }
  },
  'slate-blue': {
    name: 'Azul Marino',
    ...
    styles: {
      ...
      sidebarBg: 'bg-[#0f172a]',
      sidebarBorder: 'border-[#3b82f6]',
      activeTabBg: 'bg-[#93c5fd]',
      activeTabText: 'text-[#0f172a] border-[#0f172a] shadow-[2px_2px_0_0_#ffffff]',
      headerBorder: 'border-[#3b82f6]',
      cardBg: 'bg-white',
      cardBorder: 'border-2 border-[#0f172a]',
      cardShadow: 'shadow-[4px_4px_0_0_#1e40af]',
      textColor: 'text-[#0f172a]',
      subtextColor: 'text-[#2563eb]',
      primaryBtnBg: 'bg-[#1e40af]',
      primaryBtnHover: 'hover:bg-[#1e3a5f]',
      primaryBtnText: 'text-white border-2 border-[#0f172a] shadow-[2px_2px_0_0_#000000]',
      badgeBg: 'bg-[#dbeafe] text-[#1e40af] border border-[#bfdbfe]',
      badgeText: 'text-[#1e40af]',
      tabBarBg: 'bg-[#0f172a]',
      tabBarBorder: 'border-[#1e40af]',
      tabActiveBg: 'bg-white',
      tabActiveText: 'text-[#1e40af] font-extrabold border-b-4 border-[#1e40af]',
      tabInactiveText: 'text-white',
      tabInactiveHover: 'hover:bg-[#1e293b]',
      tabShadow: 'shadow-[4px_4px_0_0_#0f172a]'
    }
  },
  'dark-gray': {
    name: 'Gris Oscuro',
    ...
    styles: {
      bg: 'bg-[#f1f5f9]',
      sidebarBg: 'bg-[#1e293b]',
      sidebarBorder: 'border-[#64748b]',
      activeTabBg: 'bg-[#cbd5e1]',
      activeTabText: 'text-[#0f172a] border-[#0f172a]',
      headerBorder: 'border-[#64748b]',
      cardBg: 'bg-white',
      cardBorder: 'border-2 border-[#1e293b]',
      cardShadow: 'shadow-[4px_4px_0_0_#475569]',
      textColor: 'text-[#0f172a]',
      subtextColor: 'text-[#475569]',
      primaryBtnBg: 'bg-[#475569]',
      primaryBtnHover: 'hover:bg-[#334155]',
      primaryBtnText: 'text-white border-2 border-[#0f172a] shadow-[2px_2px_0_0_#000000]',
      badgeBg: 'bg-[#e2e8f0] text-[#334155] border border-[#cbd5e1]',
      badgeText: 'text-[#334155]',
      tabBarBg: 'bg-[#1e293b]',
      tabBarBorder: 'border-[#0f172a]',
      tabActiveBg: 'bg-white',
      tabActiveText: 'text-[#0f172a] font-extrabold border-b-4 border-[#475569]',
      tabInactiveText: 'text-white',
      tabInactiveHover: 'hover:bg-[#334155]',
      tabShadow: 'shadow-[4px_4px_0_0_#1e293b]'
    }
  },
  'mint-gray': {
    name: 'Menta Frío',
    ...
    styles: {
      bg: 'bg-[#f0fdf4]',
      sidebarBg: 'bg-[#0f766e]',
      sidebarBorder: 'border-[#2dd4bf]',
      activeTabBg: 'bg-[#99f6e4]',
      activeTabText: 'text-[#115e59] border-[#115e59]',
      headerBorder: 'border-[#2dd4bf]',
      cardBg: 'bg-white',
      cardBorder: 'border-2 border-[#0f766e]',
      cardShadow: 'shadow-[4px_4px_0_0_#0f766e]',
      textColor: 'text-[#115e59]',
      subtextColor: 'text-[#0d9488]',
      primaryBtnBg: 'bg-[#0f766e]',
      primaryBtnHover: 'hover:bg-[#115e59]',
      primaryBtnText: 'text-white border-2 border-[#042f2e] shadow-[2px_2px_0_0_#000000]',
      badgeBg: 'bg-[#ccfbf1] text-[#0f766e] border border-[#99f6e4]',
      badgeText: 'text-[#0f766e]',
      tabBarBg: 'bg-[#0f766e]',
      tabBarBorder: 'border-[#042f2e]',
      tabActiveBg: 'bg-white',
      tabActiveText: 'text-[#0f766e] font-extrabold border-b-4 border-[#0f766e]',
      tabInactiveText: 'text-white',
      tabInactiveHover: 'hover:bg-[#115e59]',
      tabShadow: 'shadow-[4px_4px_0_0_#0f766e]'
    }
  },
  'cyan-bright': {
    name: 'Cian Brillante',
    ...
    styles: {
      bg: 'bg-[#ecfdf5]',
      sidebarBg: 'bg-[#065f46]',
      sidebarBorder: 'border-[#34d399]',
      activeTabBg: 'bg-[#a7f3d0]',
      activeTabText: 'text-[#064e3b] border-[#064e3b]',
      headerBorder: 'border-[#34d399]',
      cardBg: 'bg-white',
      cardBorder: 'border-2 border-[#065f46]',
      cardShadow: 'shadow-[4px_4px_0_0_#059669]',
      textColor: 'text-[#064e3b]',
      subtextColor: 'text-[#059669]',
      primaryBtnBg: 'bg-[#059669]',
      primaryBtnHover: 'hover:bg-[#047857]',
      primaryBtnText: 'text-white border-2 border-[#064e3b] shadow-[2px_2px_0_0_#000000]',
      badgeBg: 'bg-[#d1fae5] text-[#065f46] border border-[#a7f3d0]',
      badgeText: 'text-[#065f46]',
      tabBarBg: 'bg-[#065f46]',
      tabBarBorder: 'border-[#064e3b]',
      tabActiveBg: 'bg-white',
      tabActiveText: 'text-[#059669] font-extrabold border-b-4 border-[#059669]',
      tabInactiveText: 'text-white',
      tabInactiveHover: 'hover:bg-[#047857]',
      tabShadow: 'shadow-[4px_4px_0_0_#065f46]'
    }
  },
  'green-light': {
    name: 'Verde Hoja',
    ...
    styles: {
      bg: 'bg-[#f7fee7]',
      sidebarBg: 'bg-[#3f6212]',
      sidebarBorder: 'border-[#a3e635]',
      activeTabBg: 'bg-[#d9f99d]',
      activeTabText: 'text-[#1a2e05] border-[#1a2e05]',
      headerBorder: 'border-[#a3e635]',
      cardBg: 'bg-white',
      cardBorder: 'border-2 border-[#3f6212]',
      cardShadow: 'shadow-[4px_4px_0_0_#65a30d]',
      textColor: 'text-[#1a2e05]',
      subtextColor: 'text-[#4d7c0f]',
      primaryBtnBg: 'bg-[#65a30d]',
      primaryBtnHover: 'hover:bg-[#4d7c0f]',
      primaryBtnText: 'text-white border-2 border-[#1a2e05] shadow-[2px_2px_0_0_#000000]',
      badgeBg: 'bg-[#ecfccb] text-[#3f6212] border border-[#d9f99d]',
      badgeText: 'text-[#3f6212]',
      tabBarBg: 'bg-[#3f6212]',
      tabBarBorder: 'border-[#1a2e05]',
      tabActiveBg: 'bg-white',
      tabActiveText: 'text-[#3f6212] font-extrabold border-b-4 border-[#65a30d]',
      tabInactiveText: 'text-white',
      tabInactiveHover: 'hover:bg-[#4d7c0f]',
      tabShadow: 'shadow-[4px_4px_0_0_#3f6212]'
    }
  },
  'sage-green': {
    name: 'Verde Olivo',
    ...
    styles: {
      bg: 'bg-[#f8fafc]',
      sidebarBg: 'bg-[#292524]',
      sidebarBorder: 'border-[#84cc16]',
      activeTabBg: 'bg-[#d9f99d]',
      activeTabText: 'text-[#1c1917] border-[#1c1917]',
      headerBorder: 'border-[#84cc16]',
      cardBg: 'bg-white',
      cardBorder: 'border-2 border-[#292524]',
      cardShadow: 'shadow-[4px_4px_0_0_#65a30d]',
      textColor: 'text-[#1c1917]',
      subtextColor: 'text-[#57534e]',
      primaryBtnBg: 'bg-[#4d7c0f]',
      primaryBtnHover: 'hover:bg-[#3f6212]',
      primaryBtnText: 'text-white border-2 border-[#1c1917] shadow-[2px_2px_0_0_#000000]',
      badgeBg: 'bg-[#ecfccb] text-[#3f6212] border border-[#bef264]',
      badgeText: 'text-[#3f6212]',
      tabBarBg: 'bg-[#292524]',
      tabBarBorder: 'border-[#1c1917]',
      tabActiveBg: 'bg-white',
      tabActiveText: 'text-[#4d7c0f] font-extrabold border-b-4 border-[#4d7c0f]',
      tabInactiveText: 'text-white',
      tabInactiveHover: 'hover:bg-[#44403c]',
      tabShadow: 'shadow-[4px_4px_0_0_#292524]'
    }
  },
  'gold-yellow': {
    name: 'Dorado Cálido',
    ...
    styles: {
      bg: 'bg-[#fefce8]',
      sidebarBg: 'bg-[#713f12]',
      sidebarBorder: 'border-[#facc15]',
      activeTabBg: 'bg-[#fef08a]',
      activeTabText: 'text-[#422006] border-[#422006]',
      headerBorder: 'border-[#facc15]',
      cardBg: 'bg-white',
      cardBorder: 'border-2 border-[#713f12]',
      cardShadow: 'shadow-[4px_4px_0_0_#ca8a04]',
      textColor: 'text-[#422006]',
      subtextColor: 'text-[#a16207]',
      primaryBtnBg: 'bg-[#ca8a04]',
      primaryBtnHover: 'hover:bg-[#a16207]',
      primaryBtnText: 'text-white border-2 border-[#422006] shadow-[2px_2px_0_0_#000000]',
      badgeBg: 'bg-[#fef9c3] text-[#713f12] border border-[#fef08a]',
      badgeText: 'text-[#713f12]',
      tabBarBg: 'bg-[#713f12]',
      tabBarBorder: 'border-[#422006]',
      tabActiveBg: 'bg-white',
      tabActiveText: 'text-[#713f12] font-extrabold border-b-4 border-[#ca8a04]',
      tabInactiveText: 'text-white',
      tabInactiveHover: 'hover:bg-[#854d0e]',
      tabShadow: 'shadow-[4px_4px_0_0_#713f12]'
    }
  },
  'peach-soft': {
    name: 'Durazno Suave',
    ...
    styles: {
      bg: 'bg-[#fff7ed]',
      sidebarBg: 'bg-[#7c2d12]',
      sidebarBorder: 'border-[#fb923c]',
      activeTabBg: 'bg-[#ffedd5]',
      activeTabText: 'text-[#431407] border-[#431407]',
      headerBorder: 'border-[#fb923c]',
      cardBg: 'bg-white',
      cardBorder: 'border-2 border-[#7c2d12]',
      cardShadow: 'shadow-[4px_4px_0_0_#ea580c]',
      textColor: 'text-[#431407]',
      subtextColor: 'text-[#c2410c]',
      primaryBtnBg: 'bg-[#ea580c]',
      primaryBtnHover: 'hover:bg-[#c2410c]',
      primaryBtnText: 'text-white border-2 border-[#431407] shadow-[2px_2px_0_0_#000000]',
      badgeBg: 'bg-[#ffedd5] text-[#7c2d12] border border-[#fed7aa]',
      badgeText: 'text-[#7c2d12]',
      tabBarBg: 'bg-[#7c2d12]',
      tabBarBorder: 'border-[#431407]',
      tabActiveBg: 'bg-white',
      tabActiveText: 'text-[#ea580c] font-extrabold border-b-4 border-[#ea580c]',
      tabInactiveText: 'text-white',
      tabInactiveHover: 'hover:bg-[#9a3412]',
      tabShadow: 'shadow-[4px_4px_0_0_#7c2d12]'
    }
  },
  'beige-nude': {
    name: 'Beige Cálido',
    ...
    styles: {
      bg: 'bg-[#fffbe0]',
      sidebarBg: 'bg-[#451a03]',
      sidebarBorder: 'border-[#d97706]',
      activeTabBg: 'bg-[#fef3c7]',
      activeTabText: 'text-[#451a03] border-[#451a03]',
      headerBorder: 'border-[#d97706]',
      cardBg: 'bg-white',
      cardBorder: 'border-2 border-[#451a03]',
      cardShadow: 'shadow-[4px_4px_0_0_#b45309]',
      textColor: 'text-[#451a03]',
      subtextColor: 'text-[#b45309]',
      primaryBtnBg: 'bg-[#b45309]',
      primaryBtnHover: 'hover:bg-[#92400e]',
      primaryBtnText: 'text-white border-2 border-[#451a03] shadow-[2px_2px_0_0_#000000]',
      badgeBg: 'bg-[#fef3c7] text-[#78350f] border border-[#fde68a]',
      badgeText: 'text-[#78350f]',
      tabBarBg: 'bg-[#451a03]',
      tabBarBorder: 'border-[#78350f]',
      tabActiveBg: 'bg-white',
      tabActiveText: 'text-[#b45309] font-extrabold border-b-4 border-[#b45309]',
      tabInactiveText: 'text-white',
      tabInactiveHover: 'hover:bg-[#78350f]',
      tabShadow: 'shadow-[4px_4px_0_0_#451a03]'
    }
  },
  'pink-rose': {
    name: 'Rosa Pastel',
    ...
    styles: {
      bg: 'bg-[#fff1f2]',
      sidebarBg: 'bg-[#881337]',
      sidebarBorder: 'border-[#fb7185]',
      activeTabBg: 'bg-[#fecdd3]',
      activeTabText: 'text-[#4c0519] border-[#4c0519]',
      headerBorder: 'border-[#fb7185]',
      cardBg: 'bg-white',
      cardBorder: 'border-2 border-[#881337]',
      cardShadow: 'shadow-[4px_4px_0_0_#e11d48]',
      textColor: 'text-[#4c0519]',
      subtextColor: 'text-[#e11d48]',
      primaryBtnBg: 'bg-[#e11d48]',
      primaryBtnHover: 'hover:bg-[#be123c]',
      primaryBtnText: 'text-white border-2 border-[#4c0519] shadow-[2px_2px_0_0_#000000]',
      badgeBg: 'bg-[#ffe4e6] text-[#881337] border border-[#fecdd3]',
      badgeText: 'text-[#881337]',
      tabBarBg: 'bg-[#881337]',
      tabBarBorder: 'border-[#4c0519]',
      tabActiveBg: 'bg-white',
      tabActiveText: 'text-[#e11d48] font-extrabold border-b-4 border-[#e11d48]',
      tabInactiveText: 'text-white',
      tabInactiveHover: 'hover:bg-[#9f1239]',
      tabShadow: 'shadow-[4px_4px_0_0_#881337]'
    }
  },
  'mauve-nude': {
    name: 'Malva Nude',
    ...
    styles: {
      bg: 'bg-[#fff1f2]',
      sidebarBg: 'bg-[#4a044e]',
      sidebarBorder: 'border-[#e879f9]',
      activeTabBg: 'bg-[#f5d0fe]',
      activeTabText: 'text-[#701a75] border-[#701a75]',
      headerBorder: 'border-[#e879f9]',
      cardBg: 'bg-white',
      cardBorder: 'border-2 border-[#4a044e]',
      cardShadow: 'shadow-[4px_4px_0_0_#c026d3]',
      textColor: 'text-[#701a75]',
      subtextColor: 'text-[#c026d3]',
      primaryBtnBg: 'bg-[#c026d3]',
      primaryBtnHover: 'hover:bg-[#a21caf]',
      primaryBtnText: 'text-white border-2 border-[#4a044e] shadow-[2px_2px_0_0_#000000]',
      badgeBg: 'bg-[#fae8ff] text-[#701a75] border border-[#f5d0fe]',
      badgeText: 'text-[#701a75]',
      tabBarBg: 'bg-[#4a044e]',
      tabBarBorder: 'border-[#701a75]',
      tabActiveBg: 'bg-white',
      tabActiveText: 'text-[#c026d3] font-extrabold border-b-4 border-[#c026d3]',
      tabInactiveText: 'text-white',
      tabInactiveHover: 'hover:bg-[#701a75]',
      tabShadow: 'shadow-[4px_4px_0_0_#4a044e]'
    }
  },
  'purple-magenta': {
    name: 'Púrpura Magenta',
    top: '#fbcfe8',
    left: '#701a75',
    right: '#f472b6',
    styles: {
      bg: 'bg-[#fdf2f8]',
      sidebarBg: 'bg-[#701a75]',
      sidebarBorder: 'border-[#f472b6]',
      activeTabBg: 'bg-[#fbcfe8]',
      activeTabText: 'text-[#500724] border-[#500724]',
      headerBorder: 'border-[#f472b6]',
      cardBg: 'bg-white',
      cardBorder: 'border-2 border-[#701a75]',
      cardShadow: 'shadow-[4px_4px_0_0_#db2777]',
      textColor: 'text-[#500724]',
      subtextColor: 'text-[#db2777]',
      primaryBtnBg: 'bg-[#db2777]',
      primaryBtnHover: 'hover:bg-[#be185d]',
      primaryBtnText: 'text-white border-2 border-[#500724] shadow-[2px_2px_0_0_#000000]',
      badgeBg: 'bg-[#fce7f3] text-[#701a75] border border-[#fbcfe8]',
      badgeText: 'text-[#701a75]',
      tabBarBg: 'bg-[#701a75]',
      tabBarBorder: 'border-[#500724]',
      tabActiveBg: 'bg-white',
      tabActiveText: 'text-[#db2777] font-extrabold border-b-4 border-[#db2777]',
      tabInactiveText: 'text-white',
      tabInactiveHover: 'hover:bg-[#831843]',
      tabShadow: 'shadow-[4px_4px_0_0_#701a75]'
    }
  },
  'violet-soft': {
    name: 'Violeta Suave',
    ...
    styles: {
      bg: 'bg-[#faf5ff]',
      sidebarBg: 'bg-[#581c87]',
      sidebarBorder: 'border-[#c084fc]',
      activeTabBg: 'bg-[#e9d5ff]',
      activeTabText: 'text-[#3b0764] border-[#3b0764]',
      headerBorder: 'border-[#c084fc]',
      cardBg: 'bg-white',
      cardBorder: 'border-2 border-[#581c87]',
      cardShadow: 'shadow-[4px_4px_0_0_#9333ea]',
      textColor: 'text-[#3b0764]',
      subtextColor: 'text-[#9333ea]',
      primaryBtnBg: 'bg-[#9333ea]',
      primaryBtnHover: 'hover:bg-[#7e22ce]',
      primaryBtnText: 'text-white border-2 border-[#3b0764] shadow-[2px_2px_0_0_#000000]',
      badgeBg: 'bg-[#f3e8ff] text-[#581c87] border border-[#e9d5ff]',
      badgeText: 'text-[#581c87]',
      tabBarBg: 'bg-[#581c87]',
      tabBarBorder: 'border-[#3b0764]',
      tabActiveBg: 'bg-white',
      tabActiveText: 'text-[#9333ea] font-extrabold border-b-4 border-[#9333ea]',
      tabInactiveText: 'text-white',
      tabInactiveHover: 'hover:bg-[#6b21a8]',
      tabShadow: 'shadow-[4px_4px_0_0_#581c87]'
    }
  }
};

const themePalettes: Record<string, ThemeStyles> = Object.fromEntries(
  Object.entries(COLOR_PALETTES).map(([k, v]) => [k, v.styles])
);
themePalettes['default'] = COLOR_PALETTES['blue-soft'].styles;
themePalettes['cyberpunk'] = COLOR_PALETTES['purple-magenta'].styles;
themePalettes['playcode'] = COLOR_PALETTES['gold-yellow'].styles;
...
export const StudentDashboard: React.FC<StudentDashboardProps> = ({
  ...
  const activeThemeId: string = themePreference === 'system' 
    ? (systemIsDark ? 'purple-magenta' : 'blue-soft') 
    : selectedColorPalette;

  const t = themePalettes[activeThemeId] || COLOR_PALETTES['blue-soft'].styles;
